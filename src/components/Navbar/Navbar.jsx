  ...
  return (
    <>
        ...
        <div className='flex justify-around items-center'>
            <div>
                <img src={logo} className="object-contain w-full h-12" alt='store' />
            </div>
            <div className='flex flex-row items-center'>
                ...
                <div className="flex flex-row items-center">
                    ...
                    <p className='font-inter text-base font-normal tracking-normal leading-none text-center mr-2'>Wish List</p>
                </div>
                <div className='flex flex-row items-center cursor-pointer' onClick={handleOpen}>
                    ...
                    <p className='font-inter text-base font-normal tracking-normal leading-none text-center'>Shopping Cart</p>
                    <div>
